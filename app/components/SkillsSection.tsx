  ...
  return (
    <section id="skills" className="py-32 bg-[#1E1E1E] text-[#E2FF3E]">
      <div className="max-w-[1728px] mx-auto px-8 md:px-16">
        <h2 className="font-heading text-5xl md:text-[120px] leading-none mb-16 uppercase text-[#E2FF3E]">
          Arsenal
        </h2>
        ...
        <div className="flex md:grid overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none md:grid-cols-4 auto-rows-auto md:auto-rows-[300px] gap-6 pb-10 md:pb-0 [&::-webkit-scrollbar]:hidden -mx-8 px-8 md:mx-0 md:px-0">
          ...
          {/* Card 1: Frontend */}
          <div className="shrink-0 snap-center w-[85vw] md:w-auto md:col-span-1 md:row-span-1 bg-[#E2FF3E] rounded-[40px] p-6 md:p-8 flex flex-col justify-between relative group overflow-hidden hover:shadow-[0_0_40px_rgba(226,255,62,0.4)] transition-all duration-500 min-h-[150px] md:min-h-[300px]">
          ...
          {/* Card 2: iOS Native */}
          <div className="shrink-0 snap-center w-[85vw] md:w-auto md:col-span-1 md:row-span-1 bg-[#52057E] rounded-[40px] p-6 md:p-8 flex flex-col justify-between relative group overflow-hidden min-h-[150px] md:min-h-[300px]">
            <div className="z-10 flex justify-between items-start">
          ...
          {/* Card 3: Backend & DB */}
          <div className="shrink-0 snap-center w-[85vw] md:w-auto md:col-span-1 md:row-span-1 border-[6px] border-[#E2FF3E] rounded-[40px] p-6 md:p-8 flex flex-col justify-between relative overflow-hidden group hover:bg-[#E2FF3E] transition-colors duration-500 min-h-[150px] md:min-h-[300px]">
          ...
          <div className="shrink-0 snap-center w-[85vw] md:w-auto md:col-span-1 md:row-span-2 bg-white rounded-[40px] p-6 md:p-8 flex flex-col relative min-h-[150px] md:min-h-0 group">
            <div>
            ...
            <div className="flex flex-row flex-wrap md:flex-col gap-2 md:gap-3">
              {[
                ...
                <div key={lang.name} className={`px-4 py-2 md:px-6 md:py-4 rounded-full md:rounded-2xl font-body text-xl md:text-3xl font-bold ${lang.color} transform md:hover:translate-x-4 transition-transform cursor-default shadow-md`}>
                  {lang.name}
                </div>
              ))}
            </div>
          ...
          <div className="hidden md:flex md:col-span-3 md:row-span-1 bg-black rounded-[40px] p-8 flex-col justify-center relative overflow-hidden border-[6px] border-[#333] min-h-[300px]">
            ...
            <div className="flex whitespace-nowrap animate-scroll-left mt-8">
              {[1, 2, 3].map((_, i) => (
                <div key={i} className="flex items-center mx-12">
                  ...
                  <span className="mx-12 text-4xl md:text-6xl text-[#52057E]">✦</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="md:hidden mt-6 bg-black rounded-[40px] p-6 flex flex-col justify-center relative overflow-hidden border-[4px] border-[#333] h-[160px]">
          <div className="flex items-center gap-2 mb-4">
            <GitBranch className="w-5 h-5 text-gray-500" />
            <span className="font-sans text-xs font-bold text-gray-500 uppercase tracking-widest">Workflow & Tools</span>
          </div>
          ...
          <div className="flex whitespace-nowrap animate-scroll-left" style={{ animationDuration: '10s' }}>
            {[1, 2, 3].map((_, i) => (
              <div key={i} className="flex items-center mx-4">
                ...
                <span className="mx-6 text-3xl text-[#52057E]">✦</span>
              </div>
            ))}
          </div>
        </div>
